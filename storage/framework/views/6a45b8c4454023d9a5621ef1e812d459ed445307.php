...
<body>
    ...
    <script>
        ...
        const errorEmail = document.querySelector('.error-password');
        ...
        const HandlerSignIn=(event)=>{
            ...
            if (email == '2223100422@student.ibik.ac.id' && password == '222310042'){
                alert("Email: " + email +"\nPassword: " + password);
                btnSubmit.textContent = 'Success Sign In';
            }else{
...
</html><?php /**PATH C:\Users\kiky\Documents\1. MATKUL\PW, Pak Febri\TugasAbsen\resources\views/pertemuan-6/P6PBSignIn.blade.php ENDPATH**/ ?>